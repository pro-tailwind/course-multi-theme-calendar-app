...
function CalendarButton(props) {
  ...
  return (
    <button
      ref={ref}
      {...buttonProps}
      className="hover:text-primary-600 grid aspect-square w-12 max-w-full place-items-center rounded-full border border-slate-300 text-slate-400 disabled:border-slate-200 disabled:text-slate-300 disabled:hover:text-slate-300"
    >
      {direction === 'Previous' ? (
